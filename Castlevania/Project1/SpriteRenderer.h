...
public:
    enum Type { PLAYER_TOP, PLAYER_BOTTOM, ZOMBIE, BAT, BAT_BOSS, MEDUSA, MERMAN, KNIGHT, LOOT, PANTHER, WHIP, BREAKABLES, PROJECTILES, PARTICLES, HIT_EFFECT, DEBUG_TILE, SAVE };
